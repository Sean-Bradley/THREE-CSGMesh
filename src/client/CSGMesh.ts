 ...
 class CSG {
     ...
     static nbuf3 = (ct: number) => {
         return {
             ...
             write: function (v: Vector) { (this.array[this.top++] = v.x); (this.array[this.top++] = v.y); (this.array[this.top++] = v.z); }
         }
     }
     static nbuf2 = (ct: number) => {
         return {
             top: 0,
             array: new Float32Array(ct),
             write: function (v: Vector) { (this.array[this.top++] = v.x); (this.array[this.top++] = v.y) }
         }
     }
